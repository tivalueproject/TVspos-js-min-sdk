...
exports.default = {
    ...
    isValidAddress: function(address, networkByte) {
        console.warn("Calling a depricated method. Please use 'checkAddress' method in account.js instead!");
    ...
    buildRawAddress: function(publicKeyBytes, networkByte) {
        console.warn("Calling a depricated method. Please use 'publicKeyToAddress' method in account.js instead!");
